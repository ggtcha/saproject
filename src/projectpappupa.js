    ...
    const projects = [
        {
            ...
            description: 'ทาวน์เฮาส์สมัยใหม่ที่มีการออกแบบทันสมัย',
            Location: 'กรุงเทพฯ, ประเทศไทย',
            timeline: 'เมษายน 2024 - กันยายน 2024',
        ...
        },
        {
            ...
            timeline: 'มิถุนายน 2024 - ธันวาคม 2025',
            image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQolZZSE2iDML7Yuqm-z_38WKTQxHRjc2L0fg&s",
            details: {
                size: '15.00 X 12.00 เมตร',
                area: '250 ตารางเมตร',
                rooms: [
                    { name: 'ห้องครัว', count: 1, icon: <FaUtensils /> },
                    { name: 'ห้องนอน', count: 1, icon: <FaBed /> },
                    { name: 'ห้องนั่งเล่น', count: 1, icon: <FaCouch /> },
                    { name: 'ห้องน้ำ', count: 2, icon: <FaShower /> },
        ...
        },
        {
            id: 3,
            title: 'Luxury Villa',
            description: 'วิลลาหรูที่ตั้งอยู่ในบริเวณที่เงียบสงบ',
            location: 'สมุย, ประเทศไทย',
            timeline: 'พฤษภาคม 2024 - ธันวาคม 2024',
            image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOwQ5l2irOqRyj8C2pQqv49qmdmT-CBVYafg&s",
            details: {
